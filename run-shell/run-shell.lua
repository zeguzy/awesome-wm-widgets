...
function widget.new()
                    ...
                    "," ..
                        mouse.screen.geometry.height / 2 ..
                            ",20:" ..
                                mouse.screen.geometry.width / 2 ..
                                    "," ..
                                        mouse.screen.geometry.height / 2 .. ",700:0,#2E344022:0.2,#4C566A88:1,#2E3440ff"
        }
    ...
    function widget_instance:launch()
        ...
        w.visible = true
        awful.placement.top(w, {margins = {top = 38}, parent = awful.screen.focused()})
        awful.prompt.run {
            prompt = "Run: ",
            bg_cursor = "#74aeab",
